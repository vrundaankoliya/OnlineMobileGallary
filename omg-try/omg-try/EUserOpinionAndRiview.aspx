<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EUserOpinionAndRiview.aspx.vb" Inherits="_Default" %>
  ...
  <div id="main_content">
    ...
    <div class="center_content">
      <div class="center_title_bar">
        <p>Register Of UserOpinionAndRiview</p>
                    ...
                    <tr>
                        ...
                        <div style ="width:740px;overflow:auto ;">
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                ...
                                DeleteCommand="DELETE FROM [tblProductMaster] WHERE [Product_ID] = @Product_ID" 
                                InsertCommand="INSERT INTO [tblProductMaster] ([Product_ID], [Brand_ID], [Product_Name], [Model_no], [Price], [2G_Network], [3G_Network]) VALUES (@Product_ID, @Brand_ID, @Product_Name, @Model_no, @Price, @column1, @column2)" 
                                SelectCommand="SELECT [Product_ID], [Brand_ID], [Product_Name], [Model_no], [Price], [2G_Network] AS column1, [3G_Network] AS column2 FROM [tblProductMaster]" 
                                
                                UpdateCommand="UPDATE [tblProductMaster] SET [Brand_ID] = @Brand_ID, [Product_Name] = @Product_Name, [Model_no] = @Model_no, [Price] = @Price, [2G_Network] = @column1, [3G_Network] = @column2 WHERE [Product_ID] = @Product_ID" 
                                ProviderName="<%$ ConnectionStrings:MobileConnectionString3.ProviderName %>">
                                <DeleteParameters>
