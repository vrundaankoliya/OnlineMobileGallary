<%@ Page Language="VB" AutoEventWireup="false" CodeFile="welShop.aspx.vb" Inherits="_Default" %>
...
<body>
  ...
  <div id="main_content">
    ...
    <div class="left_content">
      ...
      <ul class="left_menu">
        <li class="odd"><a href="ShopPurchaseFromAdmin.aspx">Purchase From Admin</a></li>
        <li class="even"><a href="ShopPurchaseReturn.aspx">Purchase Return</a></li>
        <li class="odd"><a href="ShopSalesToCustomer.aspx">Sales to Customer</a></li>
        <li class="even"><a href="ShopSalesReturn.aspx">sales Return</a></li>
        <li class="odd"><a href="ShopRepairing.aspx">Repairing</a></li>
        <li class="even"><a href="MessageToAdmin.aspx">Message to Admin</a></li>
        <!--<li class="odd"><a href="http://all-free-download.com/free-website-templates/">SalesReport</a></li>
        <li class="even"><a href="http://all-free-download.com/free-website-templates/">OnDemand</a></li>
        <li class="odd"><a href="http://all-free-download.com/free-website-templates/">ManagedAccount</a></li>
        <li class="even"><a href="http://all-free-download.com/free-website-templates/">UpComingProduct</a></li>-->
        <li class="odd"></li>
        </ul>
      <div class="title_box">Special Products</div>B
