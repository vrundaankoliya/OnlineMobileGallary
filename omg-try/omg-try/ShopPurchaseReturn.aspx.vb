...
Partial Class _Default
    ...
    Protected Sub btnsave0_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnedit.Click
        Response.Redirect("EShopPurchaseReturn.aspx")
    End Sub

    Protected Sub btnadd_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnadd.Click
        obs.main()
        obs.cmd.CommandText = "select Max(Purchase_Id) from tblShopPurchaseReturn "
    ...
    Protected Sub btnsave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnsave.Click
        Try
            ...
            Else
                ...
                obs.cmd.CommandText = "insert into  tblShopPurchaseReturn values('" & txtPurchaseID.Text & "','" & txtPurchaseDate.Text & "','" & txtAgency.Text & "',' " & txtProductName.Text & " ','" & txtDescription.Text & "','" & txtAboutProduct.Text & "','" & txtQuantity.Text & "','" & txtPurchaseRate.Text & "' ,'" & txtReason.Text & "' ,'" & txtNeedResponce.Text & "' )  "
