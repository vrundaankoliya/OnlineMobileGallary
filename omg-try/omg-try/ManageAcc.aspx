<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ManageAcc.aspx.vb" Inherits="_Default" %>
          ...
          <tr>
            <td><table width="410" border="0" background="images/products_details_bg.gif">
              ...
              <tr>
                ...
                <td>
                    <asp:TextBox ID="Txtpasswrd" runat="server" ForeColor="#D5D7C1" 
...
&nbsp;                    </td>
              ...
              <tr>
                <td colspan="3" style="text-align: center">
                    <asp:Button ID="btnsave" runat="server" BackColor="#6EA7B1" Font-Bold="True" 
                        Font-Names="Verdana" Font-Overline="False" Font-Strikeout="False" 
                        Font-Underline="True" ForeColor="White" Height="28px" Text="Save" 
                        Width="94px" />
                  </td>
              </tr>
              <tr>
