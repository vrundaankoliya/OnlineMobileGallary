<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EShopSalesToCustomer.aspx.vb" Inherits="_Default" %>
  ...
  <div id="main_content">
    ...
    <div class="center_content">
      <div class="center_title_bar">
        <p>Register Of ShopSalesToCustomer</p>
                    ...
                    <tr>
                        ...
                        <div style ="width:740px;overflow:auto ;">
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                ...
                                DeleteCommand="DELETE FROM [tblShopSalesToCustomer] WHERE [ID] = @original_ID AND [Buyer] = @original_Buyer AND [VAT_TIN_No] = @original_VAT_TIN_No AND [CST_TIN_No] = @original_CST_TIN_No AND [Coustomer_Name] = @original_Coustomer_Name AND [Coustomer_Address] = @original_Coustomer_Address AND [Invoice_No] = @original_Invoice_No AND [Date] = @original_Date AND [Delivery_Note] = @original_Delivery_Note AND [Suppliers_Reference] = @original_Suppliers_Reference AND [Buyers_Order_No] = @original_Buyers_Order_No AND [Sr_No] = @original_Sr_No AND [Description_Of_Goods] = @original_Description_Of_Goods AND [Quantity] = @original_Quantity AND [Rate] = @original_Rate AND [Per] = @original_Per AND [Discount] = @original_Discount AND [Amount] = @original_Amount AND [Total] = @original_Total AND [Terms_and_Condition] = @original_Terms_and_Condition AND [Payment_Mode] = @original_Payment_Mode AND [Remark] = @original_Remark" 
                                InsertCommand="INSERT INTO [tblShopSalesToCustomer] ([ID], [Buyer], [VAT_TIN_No], [CST_TIN_No], [Coustomer_Name], [Coustomer_Address], [Invoice_No], [Date], [Delivery_Note], [Suppliers_Reference], [Buyers_Order_No], [Sr_No], [Description_Of_Goods], [Quantity], [Rate], [Per], [Discount], [Amount], [Total], [Terms_and_Condition], [Payment_Mode], [Remark]) VALUES (@ID, @Buyer, @VAT_TIN_No, @CST_TIN_No, @Coustomer_Name, @Coustomer_Address, @Invoice_No, @Date, @Delivery_Note, @Suppliers_Reference, @Buyers_Order_No, @Sr_No, @Description_Of_Goods, @Quantity, @Rate, @Per, @Discount, @Amount, @Total, @Terms_and_Condition, @Payment_Mode, @Remark)" 
                                SelectCommand="SELECT * FROM [tblShopSalesToCustomer]" 
                                
                                UpdateCommand="UPDATE [tblShopSalesToCustomer] SET [Buyer] = @Buyer, [VAT_TIN_No] = @VAT_TIN_No, [CST_TIN_No] = @CST_TIN_No, [Coustomer_Name] = @Coustomer_Name, [Coustomer_Address] = @Coustomer_Address, [Invoice_No] = @Invoice_No, [Date] = @Date, [Delivery_Note] = @Delivery_Note, [Suppliers_Reference] = @Suppliers_Reference, [Buyers_Order_No] = @Buyers_Order_No, [Sr_No] = @Sr_No, [Description_Of_Goods] = @Description_Of_Goods, [Quantity] = @Quantity, [Rate] = @Rate, [Per] = @Per, [Discount] = @Discount, [Amount] = @Amount, [Total] = @Total, [Terms_and_Condition] = @Terms_and_Condition, [Payment_Mode] = @Payment_Mode, [Remark] = @Remark WHERE [ID] = @original_ID AND [Buyer] = @original_Buyer AND [VAT_TIN_No] = @original_VAT_TIN_No AND [CST_TIN_No] = @original_CST_TIN_No AND [Coustomer_Name] = @original_Coustomer_Name AND [Coustomer_Address] = @original_Coustomer_Address AND [Invoice_No] = @original_Invoice_No AND [Date] = @original_Date AND [Delivery_Note] = @original_Delivery_Note AND [Suppliers_Reference] = @original_Suppliers_Reference AND [Buyers_Order_No] = @original_Buyers_Order_No AND [Sr_No] = @original_Sr_No AND [Description_Of_Goods] = @original_Description_Of_Goods AND [Quantity] = @original_Quantity AND [Rate] = @original_Rate AND [Per] = @original_Per AND [Discount] = @original_Discount AND [Amount] = @original_Amount AND [Total] = @original_Total AND [Terms_and_Condition] = @original_Terms_and_Condition AND [Payment_Mode] = @original_Payment_Mode AND [Remark] = @original_Remark" 
                                ConflictDetection="CompareAllValues" 
                                OldValuesParameterFormatString="original_{0}">
                                <DeleteParameters>
                                    <asp:Parameter Name="original_ID" Type="Int32" />
                                    <asp:Parameter Name="original_Buyer" Type="String" />
                                    <asp:Parameter Name="original_VAT_TIN_No" Type="Int32" />
                                    <asp:Parameter Name="original_CST_TIN_No" Type="Int32" />
                                    <asp:Parameter Name="original_Coustomer_Name" Type="String" />
                                    <asp:Parameter Name="original_Coustomer_Address" Type="String" />
                                    <asp:Parameter Name="original_Invoice_No" Type="Int32" />
                                    <asp:Parameter Name="original_Date" Type="DateTime" />
                                    <asp:Parameter Name="original_Delivery_Note" Type="String" />
                                    <asp:Parameter Name="original_Suppliers_Reference" Type="String" />
                                    <asp:Parameter Name="original_Buyers_Order_No" Type="Int32" />
                                    <asp:Parameter Name="original_Sr_No" Type="Int32" />
                                    <asp:Parameter Name="original_Description_Of_Goods" Type="String" />
                                    <asp:Parameter Name="original_Quantity" Type="Int32" />
                                    <asp:Parameter Name="original_Rate" Type="Int32" />
                                    <asp:Parameter Name="original_Per" Type="Int32" />
                                    ...
                                    <asp:Parameter Name="original_Terms_and_Condition" Type="String" />
