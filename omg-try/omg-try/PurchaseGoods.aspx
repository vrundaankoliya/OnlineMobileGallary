<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PurchaseGoods.aspx.vb" Inherits="_Default" %>
  ...
  <div id="main_content">
    ...
    <div class="left_content">
      ...
      <ul class="left_menu">
        ...
        <li class="odd"><a href="NextLaunchMobile.aspx">UpComing Product</a></li>
    ...
    <div class="center_content">
      <div class="center_title_bar">
        <p>Register Of Purchase-Goods</p>
          ...
          <tr>
            <td><table width="410" border="0" background="images/products_details_bg.gif">
              ...
              <tr>
                <td width="172">
                    <asp:Image ID="Image1" runat="server" BorderStyle="Double" Height="46px" 
                        ImageUrl="~/images/connected_multiple_big.jpg" Width="55px" />                  </td>
                <td width="12">&nbsp;</td>
                <td width="212">&nbsp;                    </td>
              </tr>
              <tr>
                <td width="172">Purchase_Id</td>
                <td width="12"><div align="center">:</div></td>
                <td width="212">
                    <asp:TextBox ID="txtId" runat="server" BackColor="#EFEDED" 
              ...
              <tr>
                ...
                <td>
                    <asp:TextBox ID="txtPurchasedate" runat="server" 
                        BackColor="#EFEDED" BorderColor="#003366" TabIndex="1"></asp:TextBox>                    </td>
              </tr>
              <tr>
                <td>Agency_Name</td>
                ...
                <td style="text-align: left">
                    <asp:TextBox ID="txtAgencyname" runat="server" 
                        BackColor="#EFEDED" BorderColor="#003366" TabIndex="2"></asp:TextBox>                    </td>
              </tr>
              <tr>
                <td>Product_Name</td>
                <td style="text-align: center">:</td>
                <td>
                    <asp:TextBox ID="txtProductname" runat="server" ForeColor="Black" 
              ...
              <tr>
                ...
                <td class="style1">:</td>
                <td>
                    <asp:TextBox ID="txtQuentity" runat="server" ForeColor="Black" 
                        BackColor="#EFEDED" BorderColor="#003366"></asp:TextBox>                                           </td>
              </tr>
              <tr>
                <td>Purchase_Rate</td>
                <td class="style1">:</td>
                <td>
                    <asp:TextBox ID="txtPurchaserate" runat="server" ForeColor="Black" 
                        BackColor="#EFEDED" BorderColor="#003366"></asp:TextBox>                    </td>
              </tr>
              <tr>
                <td colspan="3" style="text-align: center">
                    ...
                    <asp:Button ID="btncancel0" runat="server" Text="Edit" 
                        BackColor="#6EA7B1" Font-Bold="True" Font-Names="Verdana" Font-Overline="False" 
                        Font-Strikeout="False" Font-Underline="True" ForeColor="White" 
                        onclientclick="#" PostBackUrl="#" Width="64px" style="height: 26px" /> </td>
              </tr>
              <tr>
