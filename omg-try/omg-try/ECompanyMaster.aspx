<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ECompanyMaster.aspx.vb" Inherits="_Default" %>
...
<body>
  ...
  <div id="header">
    ...
    <div class="oferte_content">
      ...
      <div class="oferta">
        <div class="oferta_content"> <img src="images/laptop.png" height="92" alt="" 
      ...
      <li><a href="dddindex.html" class="nav1"> Home</a></li>
       ...
       <li class="divider"></li>
        <li><a href="loginadmin.aspx" class="nav3">Log In </a></li>
                                ...
                                <Columns>
                        Register Of Company<asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                    ...
                    <tr>
                        ...
                        <div style ="width:740px;overflow:auto ;">
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                ...
                                DeleteCommand="DELETE FROM [tblCompanyMaster] WHERE [Id] = @original_Id AND [CompanyName] = @original_CompanyName" 
                                InsertCommand="INSERT INTO [tblCompanyMaster] ([Id], [CompanyName]) VALUES (@Id, @CompanyName)" 
                                SelectCommand="SELECT * FROM [tblCompanyMaster]" 
                                
                                
                                UpdateCommand="UPDATE [tblCompanyMaster] SET [CompanyName] = @CompanyName WHERE [Id] = @original_Id AND [CompanyName] = @original_CompanyName" 
