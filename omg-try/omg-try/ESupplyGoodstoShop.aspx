<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ESupplyGoodstoShop.aspx.vb" Inherits="_Default" %>
  ...
  <div id="main_content">
    ...
    <div class="center_content">
      <div class="center_title_bar">
        <p>Register Of SupplyGoodstoShop</p>
        <table width="419" height="41" border="0">
          <tr>
                        ...
                        <div style ="width:740px;overflow:auto ;">
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Shop_MRP" HeaderText="Shop_MRP" 
                                        SortExpression="Shop_MRP" />
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                ...
                                DeleteCommand="DELETE FROM [tblSupplyGoodstoShopes] WHERE [Shop_Id] = @original_Shop_Id AND [Date] = @original_Date AND [ShopName] = @original_ShopName AND [Product_Name] = @original_Product_Name AND [Quantity] = @original_Quantity AND [Shop_MRP] = @original_Shop_MRP" 
                                InsertCommand="INSERT INTO [tblSupplyGoodstoShopes] ([Shop_Id], [Date], [ShopName], [Product_Name], [Quantity], [Shop_MRP]) VALUES (@Shop_Id, @Date, @ShopName, @Product_Name, @Quantity, @Shop_MRP)" 
                                SelectCommand="SELECT [Shop_Id], [Date], [ShopName], [Product_Name], [Quantity], [Shop_MRP] FROM [tblSupplyGoodstoShopes]" 
                                
                                UpdateCommand="UPDATE [tblSupplyGoodstoShopes] SET [Date] = @Date, [ShopName] = @ShopName, [Product_Name] = @Product_Name, [Quantity] = @Quantity, [Shop_MRP] = @Shop_MRP WHERE [Shop_Id] = @original_Shop_Id AND [Date] = @original_Date AND [ShopName] = @original_ShopName AND [Product_Name] = @original_Product_Name AND [Quantity] = @original_Quantity AND [Shop_MRP] = @original_Shop_MRP" 
                                ConflictDetection="CompareAllValues" 
                                OldValuesParameterFormatString="original_{0}">
                                <DeleteParameters>
                                    <asp:Parameter Name="original_Shop_Id" Type="Int32" />
                                    <asp:Parameter Name="original_Date" Type="DateTime" />
                                    <asp:Parameter Name="original_ShopName" Type="String" />
                                    <asp:Parameter Name="original_Product_Name" Type="String" />
                                    <asp:Parameter Name="original_Quantity" Type="String" />
                                    <asp:Parameter Name="original_Shop_MRP" Type="Decimal" />
                                </DeleteParameters>
                                <UpdateParameters>
                                    ...
                                    <asp:Parameter Name="Shop_MRP" Type="Decimal" />
                                    <asp:Parameter Name="original_Shop_Id" Type="Int32" />
                                    <asp:Parameter Name="original_Date" Type="DateTime" />
                                    <asp:Parameter Name="original_ShopName" Type="String" />
                                    <asp:Parameter Name="original_Product_Name" Type="String" />
            ...
            &nbsp;<asp:Button ID="btnexcel" runat="server" Text="Excel" 
                        ...
                        onclientclick="#" PostBackUrl="#" Width="64px" style="height: 26px" /> &nbsp;&nbsp;
