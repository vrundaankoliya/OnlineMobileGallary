<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EmpMgt.aspx.vb" Inherits="_Default" %>
  ...
  <div id="main_content">
    ...
    <div class="center_content">
      <div class="center_title_bar">
        <p>Register Of EmployeManagement          </p>
          ...
          <tr>
            <td><table width="410" border="0" background="images/products_details_bg.gif">
              ...
              <tr>
                ...
                <td>
                    <asp:TextBox ID="Txtpasswrd" runat="server" 
              ...
              <tr>
                ...
                <td style="text-align: left">
                    <asp:TextBox ID="Txtpasswrd5" runat="server" 
                        BackColor="#EFEDED" BorderColor="#003366"></asp:TextBox>                    </td>
              </tr>
              <tr>
                <td>Mobieno</td>
                <td style="text-align: center">:</td>
                <td>
                    <asp:TextBox ID="Txtpasswrd1" runat="server" ForeColor="#D5D7C1" 
                        BackColor="#EFEDED" BorderColor="#003366"></asp:TextBox>                    </td>
              </tr>
              <tr>
                <td>Other No</td>
                <td style="text-align: center">:</td>
                <td>
                    <asp:TextBox ID="Txtpasswrd2" runat="server" ForeColor="#D5D7C1" 
              ...
              <tr>
                ...
                <td class="style1">:</td>
                <td>
                    <asp:TextBox ID="Txtpasswrd3" runat="server" ForeColor="#D5D7C1" 
                        BackColor="#EFEDED" BorderColor="#003366"></asp:TextBox>                    </td>
              </tr>
              <tr>
                <td>Working Time</td>
                <td class="style1">:</td>
                <td>
                    <asp:TextBox ID="Txtpasswrd4" runat="server" ForeColor="#D5D7C1" 
                        BackColor="#EFEDED" BorderColor="#003366"></asp:TextBox>                    </td>
              </tr>
              <tr>
                <td>&nbsp;</td>
