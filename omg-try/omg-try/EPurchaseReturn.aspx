<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EPurchaseReturn.aspx.vb" Inherits="_Default" %>
  ...
  <div id="main_content">
    ...
    <div class="center_content">
      <div class="center_title_bar">
        <p>Register Of PurchaseReturn</p>
        <table width="419" height="41" border="0">
          <tr>
            <td>
                <table class="style1">
        Register Of PurchaseReturn</p>
        <table width="419" height="41" border="0">
          <tr>
            <td>
                <table class="style1">
                    <tr>
                        ...
                        <div style ="width:740px;overflow:auto ;">
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                ...
                                SelectCommand="SELECT * FROM [tblPurchaseReturn]" 
                                ConflictDetection="CompareAllValues" 
                                DeleteCommand="DELETE FROM [tblPurchaseReturn] WHERE [Purchase_Id] = @original_Purchase_Id AND [Purchase_Date] = @original_Purchase_Date AND [Agency_Name] = @original_Agency_Name AND [Product_Name] = @original_Product_Name AND [Description] = @original_Description AND [About_Product] = @original_About_Product AND [Quantity] = @original_Quantity AND [Purchase_Rate] = @original_Purchase_Rate AND [Reason] = @original_Reason AND [Need_A_Responce] = @original_Need_A_Responce" 
                                InsertCommand="INSERT INTO [tblPurchaseReturn] ([Purchase_Id], [Purchase_Date], [Agency_Name], [Product_Name], [Description], [About_Product], [Quantity], [Purchase_Rate], [Reason], [Need_A_Responce]) VALUES (@Purchase_Id, @Purchase_Date, @Agency_Name, @Product_Name, @Description, @About_Product, @Quantity, @Purchase_Rate, @Reason, @Need_A_Responce)" 
                                OldValuesParameterFormatString="original_{0}" 
                                UpdateCommand="UPDATE [tblPurchaseReturn] SET [Purchase_Date] = @Purchase_Date, [Agency_Name] = @Agency_Name, [Product_Name] = @Product_Name, [Description] = @Description, [About_Product] = @About_Product, [Quantity] = @Quantity, [Purchase_Rate] = @Purchase_Rate, [Reason] = @Reason, [Need_A_Responce] = @Need_A_Responce WHERE [Purchase_Id] = @original_Purchase_Id AND [Purchase_Date] = @original_Purchase_Date AND [Agency_Name] = @original_Agency_Name AND [Product_Name] = @original_Product_Name AND [Description] = @original_Description AND [About_Product] = @original_About_Product AND [Quantity] = @original_Quantity AND [Purchase_Rate] = @original_Purchase_Rate AND [Reason] = @original_Reason AND [Need_A_Responce] = @original_Need_A_Responce">
                                <DeleteParameters>
