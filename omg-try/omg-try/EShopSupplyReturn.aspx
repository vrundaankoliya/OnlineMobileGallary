<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EShopSupplyReturn.aspx.vb" Inherits="_Default" %>
  ...
  <div id="main_content">
    ...
    <div class="center_content">
      <div class="center_title_bar">
        <p>Register Of ShopSupplyReturn</p>
                        ...
                        <div style ="width:740px;overflow:auto ;">
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="SProduct_Name" HeaderText="SProduct_Name" 
                                        SortExpression="SProduct_Name" />
                                    <asp:BoundField DataField="SContact_No" HeaderText="SContact_No" 
                                        SortExpression="SContact_No" />
                                    <asp:BoundField DataField="SQuantity" HeaderText="SQuantity" 
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                ...
                                SelectCommand="SELECT * FROM [tblShopSupplyReturn]" 
                                ConflictDetection="CompareAllValues" 
                                DeleteCommand="DELETE FROM [tblShopSupplyReturn] WHERE [Shop_Id] = @original_Shop_Id AND [SDate] = @original_SDate AND [SProduct_Name] = @original_SProduct_Name AND [SContact_No] = @original_SContact_No AND [SQuantity] = @original_SQuantity AND [SDescription] = @original_SDescription" 
                                InsertCommand="INSERT INTO [tblShopSupplyReturn] ([Shop_Id], [SDate], [SProduct_Name], [SContact_No], [SQuantity], [SDescription]) VALUES (@Shop_Id, @SDate, @SProduct_Name, @SContact_No, @SQuantity, @SDescription)" 
                                OldValuesParameterFormatString="original_{0}" 
                                UpdateCommand="UPDATE [tblShopSupplyReturn] SET [SDate] = @SDate, [SProduct_Name] = @SProduct_Name, [SContact_No] = @SContact_No, [SQuantity] = @SQuantity, [SDescription] = @SDescription WHERE [Shop_Id] = @original_Shop_Id AND [SDate] = @original_SDate AND [SProduct_Name] = @original_SProduct_Name AND [SContact_No] = @original_SContact_No AND [SQuantity] = @original_SQuantity AND [SDescription] = @original_SDescription">
                                <DeleteParameters>
                                    <asp:Parameter Name="original_Shop_Id" Type="Int32" />
                                    <asp:Parameter Name="original_SDate" Type="DateTime" />
                                    <asp:Parameter Name="original_SProduct_Name" Type="String" />
                                    <asp:Parameter Name="original_SContact_No" Type="String" />
                                    <asp:Parameter Name="original_SQuantity" Type="String" />
                                    <asp:Parameter Name="original_SDescription" Type="String" />
                                </DeleteParameters>
                                <UpdateParameters>
                                    <asp:Parameter Name="SDate" Type="DateTime" />
                                    <asp:Parameter Name="SProduct_Name" Type="String" />
                                    <asp:Parameter Name="SContact_No" Type="String" />
                                    <asp:Parameter Name="SQuantity" Type="String" />
