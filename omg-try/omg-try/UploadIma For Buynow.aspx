<%@ Page Language="VB" AutoEventWireup="false" CodeFile="UploadIma For Buynow.aspx.vb" Inherits="_Default" %>
...
<body>
  ...
  <div id="main_content">
    ...
    <div class="left_content">
      ...
      <ul class="left_menu">
       <li class="odd"><a href="Shop rpt.aspx">Shop Report</a></li>
          ...
          <tr>
            <td><table width="410" border="0" background="images/products_details_bg.gif">
              ...
              <tr>
                ...
                <td width="12">:</td>
                <td width="212" class="style2">
                    <asp:TextBox ID="txtid" runat="server" style="text-align: left"></asp:TextBox>
                                           </td>
              </tr>
              <tr>
                <td class="style1">
                ...
                <td width="12">:</td>
                <td width="212" class="style2">
                    <asp:DropDownList ID="drpcmp" runat="server" AutoPostBack="True" 
                        DataSourceID="SqlDataSource1" DataTextField="CompanyName" 
                        DataValueField="CompanyName" Width="93px" Height="16px" 
              ...
              <tr>
                ...
                <td class="style2">
                    <asp:DropDownList ID="drpmod" runat="server" AutoPostBack="True" 
                        DataSourceID="SqlDataSource2" DataTextField="Model_no" 
                        DataValueField="Model_no" Height="18px" Width="93px" 
                        style="text-align: left">
                        <asp:ListItem>Asha 201</asp:ListItem>
                    </asp:DropDownList>
                                           </td>
              </tr>
              <tr>
              ...
              <tr>
                <td colspan="3" class="style2">
                    <asp:Button ID="Btnadd" runat="server" Text="Add" Height="28px" Width="47px" />
                    &nbsp;
              ...
              <tr>
                <td colspan="3" style="text-align: center">
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                        ConnectionString="<%$ ConnectionStrings:MobileConnectionString36 %>" 
                        SelectCommand="SELECT [CompanyName] FROM [tblbuynow]">
                    </asp:SqlDataSource>
                  </td>
              </tr>
              <tr>
                <td colspan="3" style="text-align: center">
                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                        ConnectionString="<%$ ConnectionStrings:MobileConnectionString37 %>" 
                        SelectCommand="SELECT [ModelNo] FROM [tblbuynow]">
                    </asp:SqlDataSource>
                  </td>
              </tr>
            </table>
