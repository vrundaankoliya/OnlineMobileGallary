<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AgencyMaster.aspx.vb" Inherits="_Default" %>
  ...
  <div id="main_content">
    ...
    <div class="left_content">
      ...
      <li class="even"><a href="SupplyGoodstoShop.aspx">Sales To Shop</a></li>
        <li class="odd"><a href="http://all-free-download.com/free-website-templates/">Sales Return</a></li>
          ...
          <tr>
            <td><table width="410" border="0" background="images/products_details_bg.gif">
              ...
              <tr>
                ...
                <td width="212">
                    <asp:TextBox ID="txtId" runat="server" BackColor="#EFEDED" 
                        BorderColor="#003366" ForeColor="Black"></asp:TextBox>                  </td>
              </tr>
              <tr>
                <td>AgencyName</td>
                ...
                <td>
                    <asp:TextBox ID="txtName" runat="server" 
                        BackColor="#EFEDED" BorderColor="#003366" ForeColor="Black"></asp:TextBox>                    </td>
              </tr>
              <tr>
                <td>Address</td>
                <td>&nbsp;</td>
              ...
              <tr>
                ...
                <td style="text-align: center">:</td>
                <td>
                    <asp:TextBox ID="txtCno" runat="server" ForeColor="Black" 
              ...
              <tr>
                ...
                <td style="text-align: center">:</td>
                <td>
                    <asp:TextBox ID="txtono" runat="server" ForeColor="Black" 
              ...
              <tr>
                <td colspan="3" style="text-align: center">
                    ...
                    <asp:Button ID="btncancel" runat="server" Text="Cancel" 
                        ...
                        Font-Strikeout="False" Font-Underline="True" ForeColor="White" 
                        onclientclick="#" PostBackUrl="#" Width="64px" /> &nbsp;
                    <asp:Button ID="btnsave0" runat="server" Text="Edit" 
                        BackColor="#6EA7B1" Font-Bold="True" Font-Names="Verdana" Font-Overline="False" 
                        Font-Strikeout="False" Font-Underline="True" ForeColor="White" 
