<%@ Page Language="VB" AutoEventWireup="false" CodeFile="shplogin.aspx.vb" Inherits="_Default" %>
            ...
            <td><table width="410" border="0" background="images/products_details_bg.gif">
              ...
              <tr>
                <td colspan="3" style="text-align: center">
                    <asp:Button ID="btnlogin" runat="server" Height="24px" Text="login" 
              ...
              <tr>
                <td colspan="3" style="text-align: center">
                    <asp:Label ID="Label3" runat="server" Text="Enter Proper" Visible="False"></asp:Label>
                  </td>
              </tr>
              <tr>
                <td colspan="3" style="text-align: center">
                    <asp:Label ID="Label4" runat="server" Text="Not valid " Visible="False"></asp:Label>
                  </td>
              </tr>
            </table>
            � </td>
