<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Shop rpt.aspx.vb" Inherits="_Default" %>
...
<body>
  ...
  <div id="main_content">
    ...
    <div class="left_content">
      ...
      <ul class="left_menu">
        <li class="odd"><a href="NewAcc.aspx">Create Account</a></li>
        <li class="even"><a href="ProductMaster.aspx">Product Master</a></li>
        <li class="odd"><a href="PurchaseGoods.aspx">Purchase Goods</a></li>
        <li class="even"><a href="PurchaseReturn.aspx">Purchase Return</a></li>
        <li class="odd"><a href="SupplyGoodstoShop.aspx">Sales To Shop</a></li>
        <li class="even"><a href="ShopSupplyReturn.aspx">Sales Return</a></li>
        <li class="odd"><a href="http://all-free-download.com/free-website-templates/">Sales 
            Report</a></li>
        <li class="even"><a href="OnDemand.aspx">On Demand</a></li>
         <li class="odd"><a href="ManageAcc.aspx">ManageAcc</a></li>
		<li class="even"><a href="NextLaunchMobile.aspx">UpComing Product</a></li>
		<li class="odd"><a href="ShopMaster.aspx">Shop Master</a></li>
		<!--<li class="even"><a href="ShopMaster.aspx">Shop Master</a></li>-->
        </ul>
                   <div class="title_box">Special Products</div>
      <div class="border_box">
        <div class="product_title"><a href="details.html">Show Total Business</a></div>
    ...
    <div class="center_content">
      <div class="center_title_bar">
        <p>&nbsp;</p>
        <table width="419" border="0" style="height: 0px">
          <tr>
            <td>
                <table class="style1">
                    <tr>
                        <td>
                            Shop Branch Report</td>
                 Shop Branch Report</td>
                  </tr>
                    <tr>
                        <td>
                            <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" 
                                DataSourceID="SqlDataSource1" DataTextField="Shop_Name" 
                                DataValueField="Shop_Name">
                            </asp:DropDownList>
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                ConnectionString="<%$ ConnectionStrings:MobileConnectionString63 %>" 
                                SelectCommand="SELECT [Shop_Name] FROM [tblShopMaster]"></asp:SqlDataSource>
                        </td>
                  </tr>
                                       <tr>
                                           <td>
                                               <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                                                   DataKeyNames="Shop_ID" DataSourceID="SqlDataSource2">
                                                   <Columns>
                                               ...
                                               <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                                                   ConnectionString="<%$ ConnectionStrings:MobileConnectionString64 %>" 
                                                   SelectCommand="SELECT [Shop_ID], [SAddress], [SCity], [SPincode], [SState], [SContact_Number], [SContact_Person], [SEMail_ID] FROM [tblShopMaster] WHERE ([Shop_Name] = @Shop_Name)">
                                                   <SelectParameters>
                                                       <asp:ControlParameter ControlID="DropDownList1" Name="Shop_Name" 
