...
Partial Class _Default
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        Try
            obs.cmd.CommandText = "insert into tblPurchaseGoods values('" & txtId.Text & "','" & txtPurchasedate.Text & "','" & txtAgencyname.Text & "','" & txtProductname.Text & "','" & txtDescription.Text & "','" & txtQuentity.Text & "','" & txtPurchaserate.Text & "'  )"
    ...
    Protected Sub btncancel0_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btncancel0.Click
        Response.Redirect("EPurchaseGoods.aspx")
    End Sub
