<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EShopPurchaseFromAdmin.aspx.vb" Inherits="_Default" %>
  ...
  <div id="main_content">
    ...
    <div class="center_content">
      <div class="center_title_bar">
        <p>Register Of ShopPurchaseFromAdmin</p>
                    ...
                    <tr>
                        ...
                        <div style ="width:740px;overflow:auto ;">
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                ...
                                DeleteCommand="DELETE FROM [tblShopPurchaseFromAdmin] WHERE [Purchase_Id] = @original_Purchase_Id AND [Purchase_Date] = @original_Purchase_Date AND [Agency_Name] = @original_Agency_Name AND [Product_Name] = @original_Product_Name AND [Description] = @original_Description AND [Quentity] = @original_Quentity AND [Purchase_Rate] = @original_Purchase_Rate" 
                                InsertCommand="INSERT INTO [tblShopPurchaseFromAdmin] ([Purchase_Id], [Purchase_Date], [Agency_Name], [Product_Name], [Description], [Quentity], [Purchase_Rate]) VALUES (@Purchase_Id, @Purchase_Date, @Agency_Name, @Product_Name, @Description, @Quentity, @Purchase_Rate)" 
                                SelectCommand="SELECT * FROM [tblShopPurchaseFromAdmin]" 
                                
                                UpdateCommand="UPDATE [tblShopPurchaseFromAdmin] SET [Purchase_Date] = @Purchase_Date, [Agency_Name] = @Agency_Name, [Product_Name] = @Product_Name, [Description] = @Description, [Quentity] = @Quentity, [Purchase_Rate] = @Purchase_Rate WHERE [Purchase_Id] = @original_Purchase_Id AND [Purchase_Date] = @original_Purchase_Date AND [Agency_Name] = @original_Agency_Name AND [Product_Name] = @original_Product_Name AND [Description] = @original_Description AND [Quentity] = @original_Quentity AND [Purchase_Rate] = @original_Purchase_Rate" 
