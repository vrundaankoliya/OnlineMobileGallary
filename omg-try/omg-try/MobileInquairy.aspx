<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MobileInquairy.aspx.vb" Inherits="_Default" %>
  ...
  <div id="main_content">
    ...
    <div class="center_content">
      <div class="center_title_bar">
        <p>Register Of MobileInquairy</p>
          ...
          <tr>
            <td><table width="410" border="0" background="images/products_details_bg.gif">
              ...
              <tr>
                ...
                <td width="212">
                    <asp:TextBox ID="Txtname" runat="server" BackColor="#EFEDED" 
              ...
              <tr>
                ...
                <td style="margin-left: 40px">
                    <asp:TextBox ID="txtemailId" runat="server" ForeColor="Black" 
                        BackColor="#EFEDED" BorderColor="#003366"></asp:TextBox>                    </td>
              </tr>
              <tr>
                <td>Budget</td>
                <td style="text-align: center">:</td>
                <td>
                    <asp:TextBox ID="txtbudget" runat="server" ForeColor="Black" 
