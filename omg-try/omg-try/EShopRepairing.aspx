<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EShopRepairing.aspx.vb" Inherits="_Default" %>
                        ...
                        <div style ="width:740px;overflow:auto ;">
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="RepairedDate" HeaderText="RepairedDate" 
                                        SortExpression="RepairedDate" />
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                ...
                                DeleteCommand="DELETE FROM [tblShopRepairing] WHERE [Id] = @original_Id AND [Name] = @original_Name AND [Cost] = @original_Cost AND [ArrivalDate] = @original_ArrivalDate AND [RepairedDate] = @original_RepairedDate AND [BrandName] = @original_BrandName AND [ModelNo] = @original_ModelNo AND [InVoiceNo] = @original_InVoiceNo AND [ContactNo] = @original_ContactNo AND [Quantity] = @original_Quantity" 
                                InsertCommand="INSERT INTO [tblShopRepairing] ([Id], [Name], [Cost], [ArrivalDate], [RepairedDate], [BrandName], [ModelNo], [InVoiceNo], [ContactNo], [Quantity]) VALUES (@Id, @Name, @Cost, @ArrivalDate, @RepairedDate, @BrandName, @ModelNo, @InVoiceNo, @ContactNo, @Quantity)" 
                                SelectCommand="SELECT * FROM [tblShopRepairing]" 
                                
                                UpdateCommand="UPDATE [tblShopRepairing] SET [Name] = @Name, [Cost] = @Cost, [ArrivalDate] = @ArrivalDate, [RepairedDate] = @RepairedDate, [BrandName] = @BrandName, [ModelNo] = @ModelNo, [InVoiceNo] = @InVoiceNo, [ContactNo] = @ContactNo, [Quantity] = @Quantity WHERE [Id] = @original_Id AND [Name] = @original_Name AND [Cost] = @original_Cost AND [ArrivalDate] = @original_ArrivalDate AND [RepairedDate] = @original_RepairedDate AND [BrandName] = @original_BrandName AND [ModelNo] = @original_ModelNo AND [InVoiceNo] = @original_InVoiceNo AND [ContactNo] = @original_ContactNo AND [Quantity] = @original_Quantity" 
                                ...
                                <DeleteParameters>
                                    ...
                                    <asp:Parameter Name="original_RepairedDate" Type="DateTime" />
                                    <asp:Parameter Name="original_BrandName" Type="String" />
                                    <asp:Parameter Name="original_ModelNo" Type="Int32" />
                                    <asp:Parameter Name="original_InVoiceNo" Type="Int32" />
                                    <asp:Parameter Name="original_ContactNo" Type="Int32" />
                                ...
                                <UpdateParameters>
                                    ...
                                    <asp:Parameter Name="RepairedDate" Type="DateTime" />
                                    <asp:Parameter Name="BrandName" Type="String" />
                                    <asp:Parameter Name="ModelNo" Type="Int32" />
