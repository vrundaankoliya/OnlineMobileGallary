<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EShopSalesReturn.aspx.vb" Inherits="_Default" %>
  ...
  <div id="main_content">
    ...
    <div class="center_content">
      <div class="center_title_bar">
        <p>Register Of ShopSalesReturn</p>
                        ...
                        <div style ="width:740px;overflow:auto ;">
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="GivingDate" HeaderText="GivingDate" 
                                        SortExpression="GivingDate" />
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                ...
                                DeleteCommand="DELETE FROM [tblShopSalesReturn] WHERE [Id] = @original_Id AND [Name] = @original_Name AND [Address] = @original_Address AND [City] = @original_City AND [MobileNo] = @original_MobileNo AND [OtherNo] = @original_OtherNo AND [Quantity] = @original_Quantity AND [GivingDate] = @original_GivingDate AND [ReturnDate] = @original_ReturnDate" 
                                InsertCommand="INSERT INTO [tblShopSalesReturn] ([Id], [Name], [Address], [City], [MobileNo], [OtherNo], [Quantity], [GivingDate], [ReturnDate]) VALUES (@Id, @Name, @Address, @City, @MobileNo, @OtherNo, @Quantity, @GivingDate, @ReturnDate)" 
                                SelectCommand="SELECT * FROM [tblShopSalesReturn]" 
                                
                                UpdateCommand="UPDATE [tblShopSalesReturn] SET [Name] = @Name, [Address] = @Address, [City] = @City, [MobileNo] = @MobileNo, [OtherNo] = @OtherNo, [Quantity] = @Quantity, [GivingDate] = @GivingDate, [ReturnDate] = @ReturnDate WHERE [Id] = @original_Id AND [Name] = @original_Name AND [Address] = @original_Address AND [City] = @original_City AND [MobileNo] = @original_MobileNo AND [OtherNo] = @original_OtherNo AND [Quantity] = @original_Quantity AND [GivingDate] = @original_GivingDate AND [ReturnDate] = @original_ReturnDate" 
                                ...
                                <DeleteParameters>
                                    ...
                                    <asp:Parameter Name="original_OtherNo" Type="Int32" />
                                    <asp:Parameter Name="original_Quantity" Type="String" />
                                    <asp:Parameter Name="original_GivingDate" Type="DateTime" />
                                ...
                                <UpdateParameters>
                                    ...
                                    <asp:Parameter Name="OtherNo" Type="Int32" />
                                    <asp:Parameter Name="Quantity" Type="String" />
                                    <asp:Parameter Name="GivingDate" Type="DateTime" />
